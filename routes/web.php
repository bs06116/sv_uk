...
//lease
       ...
       Route::get('/property-search-cits', 'SellerController@cits')->name('property-search-cits');
        ...
        //most popular places
         ...
         Route::get('/London/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.London',compact('cities','filter'));})->name('London');
        ...
        // Route::view('/Bahawalpur', 'places.Bahawalpur')->name('Bahawalpur');
            ...
            $filter="most-recent";
            return view('places.Oxford',compact('cities','filter'));})->name('Oxford');
        ...
        // Route::view('/Chakwal', 'places.Chakwal')->name('Chakwal');
            ...
            $filter="most-recent";
            return view('places.Bath',compact('cities','filter'));})->name('Bath');
        ...
        // Route::view('/Gawadar', 'places.Gawadar')->name('Gawadar');
            ...
            $filter="most-recent";
            return view('places.Glasgow',compact('cities','filter'));})->name('Glasgow');
        ...
        // Route::view('/Gujranwala', 'places.Gujranwala')->name('Gujranwala');
         ...
         Route::get('/Cambridge/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Cambridge',compact('cities','filter'));})->name('Cambridge');
        ...
        Route::get('/Birmingham/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Birmingham',compact('cities','filter'));})->name('Birmingham');
        ...
        Route::get('/Manchester/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Manchester',compact('cities','filter'));})->name('Manchester');
        ...
        Route::get('/Newcastle/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Newcastle',compact('cities','filter'));})->name('Newcastle');
        ...
        Route::get('/Edinburgh/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Edinburgh',compact('cities','filter'));})->name('Edinburgh');
        ...
        // Route::view('/Quetta', 'places.Quetta')->name('Quetta');
         ...
         Route::get('/Liverpool/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Liverpool',compact('cities','filter'));})->name('Liverpool');
        ...
        Route::get('/Cardiff/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Cardiff',compact('cities','filter'));})->name('Cardiff');
       ...
       Route::get('/Dublin/{filter?}', function($filter = null){
            ...
            $filter="most-recent";
            return view('places.Dublin',compact('cities','filter'));})->name('Dublin');
