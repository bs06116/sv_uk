                                            ...
                                            <!------ Include the above in your HEAD tag ---------->
                                                <div class="container addPropertyDiv">
                                                    <table class="table table-striped table-responsive">
                                                      <tbody>
                                                                      ...
                                                                      <div class="col-md-8 inputGroupContainer">
                                                                         <div class="input-group">
                                                                          ...
                                                                          <select class="form-control" name="province"value="province">
                                                                              ...
                                                                              <option value="Federal"@php if($seller->province=="Federal"){echo "selected";} @endphp>Federal</option>
                                                       ...
                                                       <select required class="form-control" name="type" value="type">
                                                <option name="type"value="{{$seller->type}}" >Select Type </option>                                                     
                                                                  ...
                                                                  <div class="form-group">
                                                                                                      ...
                                                                                                      <div class="col-md-8 inputGroupContainer">
                                                                                                         <div class="input-group"><span class="input-group-addon"><i class="fa fa-bed" aria-hidden="true"></i></span><input  name="bedroom" placeholder="Bedroom" class="form-control"  value="{{$seller->bedroom}}" id="beds" type="text"></div>
                                                                                                      </div>
                                                                                                   </div>
                                                                                                   <br>
                                                                   <br>
                                                                   <div class="form-group" >
                                                                    ...
                                                                    <div class="col-md-8 inputGroupContainer">
                                                                       <div class="input-group"><span class="input-group-addon"><i class="fa fa-bath" aria-hidden="true"></i></span><input  name="Bath" placeholder="Bath" class="form-control"  value="{{$seller->Bath}}" id="baths" type="text"></div>
                                                                    </div>
                                                                 </div>
                                                                                                   <br>
                                                                                                   <br>
                                                                                                   <div class="form-group">
                                                                                                      ...
                                                                                                      <div class="col-md-8 inputGroupContainer">
                                                                                                         <div class="input-group"><span class="input-group-addon"><i class="fa fa-car" aria-hidden="true"></i></span><input  name="garage" placeholder="Garage" class="form-control"id="garages" value="{{$seller->garage}}" type="text"></div>
                                                                                                      </div>
                                                                ...
                                                                <fieldset>
                                                                   ...
                                                                   <div class="form-group">
                                                                      ...
                                                                      <div class="col-md-8 inputGroupContainer">
                                                                         <div class="input-group">
                                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                                                           <select class="form-control" required name="purpose"id="purposeType" onchange="changestatus()">
                                                                               <optgroup label="Home">
                                                                                  <option value="House"@php if($seller->purpose=="House"){echo "selected";} @endphp>Full House</option>
                                                                                  ...
                                                                                  <option value="Lower Portion"@php if($seller->purpose=="Lower Portion"){echo "selected";} @endphp>Ground Portion</option>
