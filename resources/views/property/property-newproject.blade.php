        ...
        <div class="propertyHeader">
            <div class="aboutnew">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="ipt-title" style="color: aliceblue;">Project Property List</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-8">
                        <div class="filterBox">
                            <div class="row">
                                <div class="col-lg-6">
                                    @php
                                    $count=App\Models\Seller::where('type','=','project')->count();
                                ...
                                <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option value="">Most Resent</option>
                                    </select>
                                </div> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                @php
                                $cities=App\Models\Seller::where('type','=','project')->get();
                                @endphp
