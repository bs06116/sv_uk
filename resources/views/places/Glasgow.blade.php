    ...
    <div class="propertyHeader">
        <div class="Gwadar">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="ipt-title">Glasgow List</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="filterBox">
                        <div class="row">
                            <div class="col-lg-6">
                                @php
                                    $count=App\Models\Seller::where('city','=','Glasgow')->count();
                            ...
                            <div class="col-lg-6 text-right">
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option  @php if($filter=="lowest-price"){echo "selected"; } @endphp value="{{route('Glasgow',['filter'=>'lowest-price'])}}">Lowest price</option>
                                        <option @php if($filter=="highest-price"){echo "selected"; } @endphp  value="{{route('Glasgow',['filter'=>'highest-price'])}}">Highest price</option>
                                        <option @php if($filter=="most-recent"){echo "selected"; } @endphp   value="{{route('Glasgow',['filter'=>'most-recent'])}}">Most Recent</option>
                                    </select>
                                </div>
