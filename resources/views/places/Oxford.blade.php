    ...
    <div class="propertyHeader">
        <div class="Bahawalpur">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="ipt-title">Oxford List</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="filterBox">
                        <div class="row">
                            <div class="col-lg-6">
                                @php
                                    $count=App\Models\Seller::where('city','=','Oxford')->count();
                                   ...
                                   <h4>Total Properties:<span class="theme-cl">{{ $count }}</span></h4>
                                    ...
                                    <select name="" id="filter_select" class="inputCommon">
                                        ...
                                        <option disabled selected>Relevance</option>
                                        <option  @php if($filter=="lowest-price"){echo "selected"; } @endphp value="{{route('Oxford',['filter'=>'lowest-price'])}}">Lowest price</option>
                                        <option @php if($filter=="highest-price"){echo "selected"; } @endphp  value="{{route('Oxford',['filter'=>'highest-price'])}}">Highest price</option>
                                        <option @php if($filter=="most-recent"){echo "selected"; } @endphp   value="{{route('Oxford',['filter'=>'most-recent'])}}">Most Recent</option>
                                    </select>
                                </div>
