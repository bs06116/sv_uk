            ...
            <div class="card-body">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        @php
                  $id=Auth::user()->id;
                  $count=App\Models\Portal::where('t_test','=','1')->where('user_id',$id)->get();
                  ...
                  @endphp
                        ...
                        @foreach ($count as $key => $user)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('accepttenant')}}"style="border: solid;color: white;background-color: #67a8e4;padding: 6px;border-radius: 14px;">Accept</a>
                                </td>
                                {{-- <td>
